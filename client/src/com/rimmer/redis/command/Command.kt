...
enum class Command {
    ...
    GEOADD, GEODIST, GEOHASH, GEOPOS, GEORADIUS, GEORADIUSBYMEMBER, COMMAND, HSTRLEN, READWRITE, ROLE;
...
enum class Keyword {
    ...
    REFCOUNT, ENCODING, IDLETIME, AND, OR, XOR, NOT, GETNAME, SETNAME, LIST, MATCH, COUNT, PAUSE, REPLY, ADDSLOTS,
    DELSLOTS, FAILOVER, FORGET, COUNTKEYSINSLOT, GETKEYSINSLOT, INFO, KEYSLOT, MEET, NODES, REPLICATE, SAVECONFIG,
